...

{
    ...
    double percentage;
    //============changes============
    char subject1Name[20];
    char subject2Name[20];
    char subject3Name[20];
    int subject1Marks;
    int subject2Marks;
    int subject3Marks;
    char grade;
...
void viewStudent()
{
    ...
    while(fread(&std,sizeof(std),1,fp) == 1){
        ...
        printf("%-15s|",std.subject1Name);
        printf("%-14d|",std.subject1Marks);
        printf("%-6d|",std.cgpa);
        printf("%-12d|",std.percentage);
        printf("%-6s",std.grade);
        printf("\n");
        printf("     |                     |           |         |           |           |%-15s|",std.subject2Name);
        printf("%-14d|",std.subject2Marks);
        printf("      |            |");
        printf("\n");
        printf("     |                     |           |         |           |           |%-15s|",std.subject3Name);
...
//        gets(std.course);///???
        ...
        gets(std.branch);
        //============changes============
        printf("\t\t\t Enter Subjects and its marks\n");
        printf("\t\t\t -----------------------------\t\t\t");
        printf("Enter Subject1 Name : ");
        gets(std.subject1Name);
        printf("Enter Subject2 Name : ");
        gets(std.subject2Name);
        printf("\t\t\tEnter Subject3 Name : ");
        gets(std.subject3Name);
